...
// v2.9.7: 10s cooldown after game exit check before mount, prevent background restart triggers
...
// v2.9.7: Game-exit cooldown — mount immediately, 10s cooldown after exit to block background restarts
